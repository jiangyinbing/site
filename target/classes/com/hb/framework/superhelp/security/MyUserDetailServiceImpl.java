...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		com.hb.framework.system.entity.User users = userDao.querySingleUser(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.hb.framework.system.entity.User user) {
		...
		for (Resources res : resources) {
			...
			// 关联代码：com.hb.security.MySecurityMetadataSource#loadResourceDefine
