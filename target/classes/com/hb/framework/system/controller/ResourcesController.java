 ...
 */
@Controller
@RequestMapping(value="/background/system/resources/")
public class ResourcesController {
	...
	public String addUI(Model model){
		...
		return "/background/system/resources/add";
	} 
	...
	public String query(Model model,Resources resources,String pageNow){
		...
		return "/background/system/resources/list";
	}
	...
	public String getById(Model model,String resourcesId,int typeKey){
		...
		if(typeKey == 1){
			return "/background/system/resources/edit";
		}else{
			return "/background/system/resources/show";
		}
	}
	...
	public String permissioUser(Model model,String userId){
		...
		return "/background/system/resources/permissioUser";
	}
	/**
	 * 某个角色拥有的权限
	 * @return
