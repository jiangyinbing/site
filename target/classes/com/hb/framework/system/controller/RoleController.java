 ...
 */
@Controller
@RequestMapping(value="/background/system/role/")
public class RoleController {
	...
	public String addUI(Model model){
		...
		return "/background/system/role/add";
	} 
	/**
	 * 权限树
	 * @return
	...
	public String query(Model model,Roles role,String pageNow){
		...
		return "/background/system/role/list";
	}
	...
	public String getById(Model model,String roleId,int typeKey){
		...
		if(typeKey == 1){
			return "/background/system/role/edit";
		}else{
			return "/background/system/role/show";
		}
	}
...
//		return "/background/system/role/permissioUser";
//	}
}
