...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
        ...
        function uploadfile(fid){
        	...
        	$.ajaxFileUpload({
		        url:'${pageContext.servletContext.contextPath }/background/system/order/addpersonimg.html?id='+id+'&title='+encodeURI(encodeURI(title)),//处理图片
		        secureuri :false,
		...
		function list(){
			$.ajax({
				type:'post',
				url:'${pageContext.servletContext.contextPath }/background/system/order/filelist.html',
				dataType:'json',
				success:function(data){
					process(data);
				}
