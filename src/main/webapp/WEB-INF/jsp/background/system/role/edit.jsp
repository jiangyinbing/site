...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="${pageContext.servletContext.contextPath }/background/system/role/update.html" method="post">
				...
				<tr>	
					...
					<td >
						<div align="left"   style="padding-left:10px;">
							 <input style="height: 20px;width: 200px" name="name" type="text" value="${role.name}" data-validator-group="customValidatorGroupName" data-validator-required="请输入角色名."/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
						<div align="left"   style="padding-left:10px;">
							 <input style="height: 20px;width: 200px" name="roleKey" type="text" value="${role.roleKey}" data-validator-group="customValidatorGroupName" data-validator-required="请输入角色roleKey."/>
						</div>
					</td>
				</tr>
				<tr>	
