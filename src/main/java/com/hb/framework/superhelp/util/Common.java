...
import com.hb.framework.system.controller.ServerInfoController;
import com.hb.framework.system.entity.ServerStatus;
import com.hb.framework.system.entity.ServerStatus.CpuInfoVo;
import com.hb.framework.system.entity.ServerStatus.DiskInfoVo;
...
public class Common {
    ...
    public static HttpServletResponse setResponse(HttpServletResponse response,String fileName) throws UnsupportedEncodingException{
        ...
        response.setHeader("Content-Disposition", "inline;filename=" + new String((fileName).getBytes(), "ISO8859_1") + ".xls");// 组装附件名称和格式  
    	return response;
    }
	/**
	 * 判断变量是否为空
	...
	/**
	 * 把字符数组转换为字符串['123','456']>'123456'
	 * @param args 字符数组
	 * @return 字符串
	 */
    public static String getStrArryToStr(String[] args){
    	String str=null;
	 ...
	 * @return String
	 */
	public static String fromStringToDate(Date date){
