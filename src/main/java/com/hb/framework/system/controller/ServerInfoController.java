...
import com.hb.framework.system.service.ServerInfoService;
 ...
 */
@Controller
@RequestMapping(value = "/background/system/serverInfo/")
public class ServerInfoController {
	...
	public String queryUserLogin(Model model, ServerInfo serverInfo, String pageNow){
		...
		return "/background/system/server/list";
	}
	@RequestMapping(value = "show")
	public String show() {
		return "/background/system/server/show";
	}

	@RequestMapping(value = "forecast")
	public String forecast() {
		return "/background/system/server/forecast";
	}
